...
2. Si la tarea está acabada: **no marques `done` tú mismo**. Presenta el resultado
   al humano con un resumen del trabajo y el veredicto del reviewer. El humano
   decide si cerrar la feature.
