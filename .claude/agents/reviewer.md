...
1. Lee `docs/architecture.md`, `docs/conventions.md`, `CHECKPOINTS.md`.
   - Si la feature tiene `"sdd": true` en `feature_list.json`, lee también
     `specs/<nombre>/design.md` y verifica que el código lo sigue.
...
- C1: [x]
- C2: [x]
- C3: [ ] ← Razón: ikctl/remote/connect.py importa requests, viola "sin dependencias externas"
- C4: [x]
- C5: [x]
