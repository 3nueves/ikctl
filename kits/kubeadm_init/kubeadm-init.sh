...
CONTROL_PLANE_ENDPOINT="endpoint-kubes.forum.ibits.lan:6443"
APISERVER_CERT_EXTRA_SANS="k8s.forum.ibits.lan,k8s-forum.ibits.lan,k8s-forum.invisiblebits.com"
